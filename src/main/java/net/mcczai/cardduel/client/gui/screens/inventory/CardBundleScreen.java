...
import net.mcczai.cardduel.item.inventory.CardBundleMenu;
...
public class CardBundleScreen extends AbstractContainerScreen<CardBundleMenu> {
    ...
    private static final ResourceLocation CARD_BUNDLE_LOCATION = new  ResourceLocation( CardduelMod.MODID, "textures/gui/container/card_bundle.png");
